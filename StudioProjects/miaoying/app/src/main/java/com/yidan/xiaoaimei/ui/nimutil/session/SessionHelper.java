package com.yidan.xiaoaimei.ui.nimutil.session;
...
import com.netease.nim.uikit.nimutil.session.extension.CustomAttachParser;
import com.netease.nim.uikit.nimutil.session.extension.CustomAttachment;
import com.netease.nim.uikit.nimutil.session.extension.RTSAttachment;
import com.netease.nim.uikit.nimutil.session.extension.RedPacketAttachment;
import com.netease.nim.uikit.nimutil.session.extension.SnapChatAttachment;
import com.netease.nim.uikit.nimutil.session.extension.StickerAttachment;
...
import com.yidan.xiaoaimei.ui.nimutil.session.action.EvaluationAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.FileAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.GiftAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.GuessAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.PhotoPayAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.SnapChatAction;
import com.yidan.xiaoaimei.ui.nimutil.session.action.TipAction;
import com.yidan.xiaoaimei.ui.nimutil.session.activity.MessageHistoryActivity;
import com.yidan.xiaoaimei.ui.nimutil.session.activity.MessageInfoActivity;
import com.yidan.xiaoaimei.ui.nimutil.session.search.SearchMessageActivity;
import com.yidan.xiaoaimei.ui.nimutil.session.viewholder.MsgViewHolderDefCustom;
import com.yidan.xiaoaimei.ui.nimutil.session.viewholder.MsgViewHolderRTS;
import com.yidan.xiaoaimei.ui.nimutil.session.viewholder.MsgViewHolderSnapChat;
import com.yidan.xiaoaimei.ui.nimutil.session.viewholder.MsgViewHolderSticker;
import com.yidan.xiaoaimei.ui.nimutil.session.viewholder.MsgViewHolderTip;
...
public class SessionHelper {
    ...
    public static void startP2PSession(Context context, String account, List<GiftListInfo.DataBean> gifts) {
        startP2PSession(context, account, null, gifts);
    }

    public static void startP2PSession(Context context, String account, IMMessage anchor, List<GiftListInfo.DataBean> gifts) {
//        if (!MyCache.getAccount().equals(account)) {
        if (NimUIKit.getRobotInfoProvider().getRobotByAccount(account) != null) {
            NimUIKit.startChatting(context, account, SessionTypeEnum.P2P, getRobotCustomization(), anchor, gifts);
        } else {
            NimUIKit.startP2PSession(context, account, anchor, gifts);
        }
//        } else {
...
//            }
            actions.add(new PhotoPayAction());
            actions.add(new EvaluationAction());
...
//                UserProfileActivity.start(context, message.getFromAccount());
            ...
            @Override
            public void onSendGiftClicked(Context context, GiftListInfo.DataBean gift, int num) {
...
//                sessionTypeEnum, MyCache.getContext().getString(R.string.message_history_query)));
//        moreMenuItems.add(new PopupMenuItem(context, ACTION_SEARCH_MESSAGE, sessionId,
//                sessionTypeEnum, MyCache.getContext().getString(R.string.message_search_title)));
//        moreMenuItems.add(new PopupMenuItem(context, ACTION_CLEAR_MESSAGE, sessionId,
//                sessionTypeEnum, MyCache.getContext().getString(R.string.message_clear)));
