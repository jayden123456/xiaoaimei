...
public final class NimUIKitImpl {
    ...
    */
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor, List<GiftListInfo.DataBean> gifts) {
        NimUIKitImpl.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor, gifts);
    }
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor, List<GiftListInfo.DataBean> gifts) {
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(context, id, customization, anchor, gifts);
