...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor, List<GiftListInfo.DataBean> gifts) {
        Intent intent = new Intent();
        intent.putExtra(Extras.EXTRA_ACCOUNT, contactId);
        intent.putExtra(Extras.EXTRA_CUSTOMIZATION, customization);
        intent.putExtra(Extras.EXTRA_GIFTS, (Serializable) gifts);
        if (anchor != null) {
