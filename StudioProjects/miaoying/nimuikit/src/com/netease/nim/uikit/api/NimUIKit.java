...
public class NimUIKit {
    ...
    public static void startP2PSession(Context context, String account, List<GiftListInfo.DataBean> gifts) {
        NimUIKitImpl.startP2PSession(context, account, gifts);
    }
    ...
    /**
     * 同 {@link NimUIKitImpl#startP2PSession(Context, String, List<GiftListInfo.DataBean>)},同时聊天界面打开后，列表跳转至anchor位置
     *
     * @param context 上下文
     * @param account 目标账号
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor, List<GiftListInfo.DataBean> gifts) {
        NimUIKitImpl.startP2PSession(context, account, anchor, gifts);
    }
