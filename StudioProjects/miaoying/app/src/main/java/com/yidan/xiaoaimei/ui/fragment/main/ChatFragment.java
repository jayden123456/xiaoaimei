...
import com.netease.nim.uikit.nimutil.session.extension.GuessAttachment;
...
import com.netease.nim.uikit.nimutil.session.extension.RedPacketOpenedAttachment;
...
import com.yidan.xiaoaimei.presenter.ChatPresenter;
import com.yidan.xiaoaimei.ui.nimutil.reminder.ReminderManager;
...
public class ChatFragment extends BaseFragment implements ChatContract.IChatView {
...
//                }
    ...
    Observer<List<OnlineClient>> clientsObserver = new Observer<List<OnlineClient>>() {
        ...
        public void onEvent(List<OnlineClient> onlineClients) {
            ChatFragment.this.onlineClients = onlineClients;
        ...
        fragment.setCallback(new RecentContactsCallback() {
            ...
            public void onItemClick(RecentContact recent) {
                ...
                switch (recent.getSessionType()) {
                    case P2P:
                        SessionHelper.startP2PSession(getActivity(), recent.getContactId(), gifts);
                        break;
                    case Team:
