...
import com.yidan.xiaoaimei.ui.view.ImageViewPaper;
...
public class ShowPictureActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    @BindView(R.id.viewPager_showPhoto)
    ImageViewPaper viewPager;
    /**
...
//    }
    ...
    public void initData() {
        ...
        if (getIntent() != null && getIntent().hasExtra("imgdatas")) {
            ...
            imgDatas = gson.fromJson(getIntent().getStringExtra("imgdatas"), new TypeToken<List<String>>() {
            }.getType());
             ...
             * 当前item缩略图没加载完成不能显示
             */
//            if (!BitmapUtil.checkImageExist(ImageStringUtil.getThumb(imgDatas.get(positon), item_hight, item_width))) {
//                finishAct();
//                return;
//            }
