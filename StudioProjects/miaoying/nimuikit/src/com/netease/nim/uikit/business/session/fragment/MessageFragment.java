...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    private void parseIntent() {
        ...
        gifts = (List<GiftListInfo.DataBean>) getArguments().getSerializable(Extras.EXTRA_GIFTS);
        ...
        if (inputPanel == null) {
            ...
            inputPanel.setGiftData(gifts);
        } else {
            inputPanel.reload(container, customization, gifts);
        }
