...
public abstract class MsgViewHolderBase extends RecyclerViewHolder<BaseMultiItemFetchLoadAdapter, BaseViewHolder, IMMessage> {
    ...
    // 当是接收到的礼物消息时，内容区域背景的drawable id
    protected int leftGiftBackground() {
        return NimUIKitImpl.getOptions().messageGiftLeftBackground;
    }

    // 当是发送出去的礼物消息时，内容区域背景的drawable id
    protected int rightGiftBackground() {
        return NimUIKitImpl.getOptions().messageGiftRightBackground;
    }
    ...
    private void setContent() {
        ...
        if (isMiddleItem()) {
            ...
            if (isReceivedMessage()) {
                ...
                if (message.getAttachment() instanceof RTSAttachment) {
                    contentContainer.setBackgroundResource(leftGiftBackground());
                } else {
                ...
                if (message.getAttachment() instanceof RTSAttachment) {
                    contentContainer.setBackgroundResource(rightGiftBackground());
                } else {
