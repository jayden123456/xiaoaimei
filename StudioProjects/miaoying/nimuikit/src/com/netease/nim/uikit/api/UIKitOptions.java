...
public class UIKitOptions {
    ...
    /**
     * IM 接收到的礼物消息时，内容区域背景的drawable id
     */
    public int messageGiftLeftBackground = R.drawable.nim_message_gift_left;

    /**
     * IM 发送出去的礼物消息时，内容区域背景的drawable id
     */
    public int messageGiftRightBackground = R.drawable.nim_message_gift_right;
