...
public class CountDownTimerUtilsNew extends CountDownTimer {
    ...
    public CountDownTimerUtilsNew(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setBackgroundResource(R.drawable.common_unclick_button); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.common_red_button);
