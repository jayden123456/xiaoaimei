...
/**
 * Created by Jayden on 2016/1/15.
 */
public class SpacesCommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpacesCommonItemDecoration(int leftRight, int topBottom) {
        this.leftRight = leftRight;
        this.topBottom = topBottom;
    }

    public SpacesCommonItemDecoration(int leftRight, int topBottom, int mColor) {
